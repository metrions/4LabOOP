...
int main(){
    ...
    Distribution newDist2;
    newDist2.load("./files/newfile.txt");
    Mixture mix2 = Mixture(newDist1, newDist2, 0.1);

    Mixture<Distribution, Mixture<Distribution, Distribution>> mix(newDist1, mix2, 0.2);
    mix.load("./files/file.txt");
    cout << mix.density(0);

    mix.saveTofile("./files/out.txt");

    // Mixture<Distribution, Distribution> mix(newDist1, newDist2, 0.4);
    ...
    // Mixture<Empiric, Empiric> mix(empiric1, empiric, 0.5);
    // cout << mix.density(0) ;
